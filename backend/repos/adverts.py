...
from ..models.adverts import adverts
from ..models.menu import menu
from ..models.advert_files import advert_files
from ..models.adverts_search import adverts_search
from ..models.files import files
from ..schemas import adverts as sch
...
class AdvertsRepo:
    ...
    @classmethod
    async def get_adverts(cls, page, size):
        query = (
            select(adverts, menu.c.menu_name, menu.c.parent_id)
